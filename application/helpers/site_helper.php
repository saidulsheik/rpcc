...
if(!function_exists('number_to_bangla')) {
	function number_to_bangla($number=null){
        ...
        $res = "";
        if ($Kt) {
            $res .= number_to_bangla($Kt) . " কোটি ";
        }
        if ($Gn) {
            $res .= number_to_bangla($Gn) . " লাখ";
        }
        if ($kn)
        {
            $res .= (empty($res) ? "" : " ") .
                number_to_bangla($kn) . " হাজার";
        }
        if ($Hn)
        {
            $res .= (empty($res) ? "" : " ") .
                number_to_bangla($Hn) . " শত";
        }

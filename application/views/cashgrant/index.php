    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createCashgrant', $user_permission)): ?>
          <a href="<?php echo base_url('cashgrants/create') ?>" class="btn btn-primary">Add New</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Cash Grant</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'cashgrants/fetchCashGrantData',
    'order': []
  });

    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createUnicefFund', $user_permission)): ?>
          <a href="<?php echo base_url('Uniceffunds/create') ?>" class="btn btn-primary">Add New</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Unicef Fund</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              <caption>Unicef Funds</caption>
              <thead>
              <tr>
                <th>Sl No.</th>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'Uniceffunds/fetchUnicefFundData',
    'order': []
  });

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Report Text</li>
      </ol>
    </section>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Report Text</h3>
            </div>
            ...
            <div class="form-group">
                ...
                <input  type="text" class="form-control" id="name" name="name" value="<?php echo !empty($reporttext_data['name'])?$reporttext_data['name']:'';?>">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea  rows="4" placeholder="Report Header 1" class="form-control" id="header1" name="header1">
                            <?php echo !empty($reporttext_data['header1'])?$reporttext_data['header1']:'';?>
                        </textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php echo !empty($reporttext_data['header2'])?$reporttext_data['header2']:'';?>
                        </textarea>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea   rows="4"  placeholder="Report Footer 1" class="form-control" id="footer1" name="footer1">
                                <?php echo !empty($reporttext_data['footer1'])?$reporttext_data['footer1']:'';?>
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="footer2">Report Footer2</label>
                            <textarea   rows="4"  placeholder="Report Footer 2" class="form-control" id="footer2" name="footer2">
                                <?php echo !empty($reporttext_data['footer2'])?$reporttext_data['footer2']:'';?>
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea  rows="4"  placeholder="Report Signature Left" class="form-control" id="signature_left" name="signature_left">
                                <?php echo !empty($reporttext_data['signature_left'])?$reporttext_data['signature_left']:'';?>
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea   rows="4"  placeholder="Report Signature Right" class="form-control" id="signature_right" name="signature_right">
                                <?php echo !empty($reporttext_data['signature_right'])?$reporttext_data['signature_right']:'';?>
                            </textarea>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#manageReportText").addClass('active');
    //$("#message").wysihtml5();
    $("#header1").wysihtml5();
    $("#header2").wysihtml5();
    $("#footer1").wysihtml5();

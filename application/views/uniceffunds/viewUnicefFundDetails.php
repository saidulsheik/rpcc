...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Unicef Fund Report</li>
    </ol>
  </section>
  <style>
        table, tr, th, td {
            ...
            <div class="col-md-12 col-xs-12">
                <div class="box">
					<div class="box-header">
						<h3 class="box-title">Unicef Fund Report</h3>
					</div>
                    <div class="box-body">
                        <div class="col-sm-2">
						 ...
						 <div class="col-sm-4">
							<a href="<?php echo base_url('uniceffunds/excelExport/').$uniceffunds['unief_fund_master']['unicef_fund_id'] ?>" class="btn btn-primary pull-right">Excel Export</a>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="tbl_unicef_report" style="">
  ...
  <script>
    function printData(){
       var divToPrint=document.getElementById("tbl_unicef_report");
       var htmlToPrint = '' +
          '<style type="text/css">' +
          'table {' +
